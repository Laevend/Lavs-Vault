package coffee.laeven.lavsvault.utils.data;
...
{
	private static NamespacedKey dataKey = new NamespacedKey(LavsVault.instance(),"JSON_DATA_MAP");
	...
	public static boolean has(String key,PersistentDataHolder dataHolder)
	{
		...
		NamespacedKey NSKey = new NamespacedKey(LavsVault.instance(),key);
