...
public class SoundUtils
{
	...
	public static final SoundMixer ARMOUR_CRACK;
	public static final SoundMixer VAULTED_ITEM;
	...
	static
	{
		...
		ARMOUR_CRACK = new SoundUtils().new SoundMixer(Sound.ITEM_WOLF_ARMOR_CRACK,2.0f);
		ARMOUR_CRACK.addSound(Sound.ITEM_ARMOR_EQUIP_NETHERITE,0.1f,2);
		ARMOUR_CRACK.addSound(Sound.ITEM_ARMOR_EQUIP_CHAIN,0.1f,2);
		ARMOUR_CRACK.addSound(Sound.ITEM_ARMOR_EQUIP_LEATHER,0.1f,2);
		
		VAULTED_ITEM = new SoundUtils().new SoundMixer(Sound.BLOCK_VAULT_STEP,0.1f);
		VAULTED_ITEM.addSound(Sound.BLOCK_VAULT_OPEN_SHUTTER,2.0f,0);
		VAULTED_ITEM.addSound(Sound.BLOCK_VAULT_BREAK,1.5f,0);
		VAULTED_ITEM.addSound(Sound.BLOCK_VAULT_REJECT_REWARDED_PLAYER,1.8f,0);
	}
