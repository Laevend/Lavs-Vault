package coffee.laeven.lavsvault.utils.tools;
...
import coffee.laeven.lavsvault.exception.InvalidFileException;
...
public class ClasspathCollector
{
	...
	{
		this.loaderRef = LavsVault.class.getClassLoader();
		this.jarRef = LavsVault.getPluginPath();
	}
